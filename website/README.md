...
A platform designed specifically for Nepali creators to monetize their content, build communities, and connect with supporters through local payment solutions.

## 🎯 What is Creators Nepal?

Creators Nepal is a creator-focused platform that enables Nepali content creators to monetize their work and build sustainable income streams. Built specifically for Nepal's creative economy, Creators Nepal supports local payment gateways like eSewa and Khalti, making it easy for creators to receive support from their audience.
...
- **Local Payment Solutions**: Accept payments through eSewa and Khalti - Nepal's most trusted payment gateways
- **Community Building**: Connect with supporters, share exclusive content, and build lasting relationships
- **Made for Nepal**: Built specifically for Nepali creators with local language support and cultural understanding
- **Creator-Centric**: Built with Nepali creators' needs in mind
- **Modern Stack**: Fast, reliable, and scalable platform
...
```bash
git clone https://github.com/creatorsnepal/creators-nepal.git
cd creators-nepal/website
```
...
- [x] Payment processing integration (eSewa & Khalti)
- [x] Creator dashboard
...
- **Documentation**: Check our [wiki](https://github.com/creatorsnepal/creators-nepal/wiki)
- **Issues**: Report bugs on [GitHub Issues](https://github.com/creatorsnepal/creators-nepal/issues)
- **Discussions**: Join conversations in [GitHub Discussions](https://github.com/creatorsnepal/creators-nepal/discussions)
...
**Creators Nepal** - Empowering Nepal's creative economy with local payment solutions, community building tools, and creator-focused features.
